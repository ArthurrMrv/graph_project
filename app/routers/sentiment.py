...
async def sync_sentiments(request: SyncSentimentsRequest):  # pylint: disable=too-many-branches, too-many-statements, too-many-locals, too-many-nested-blocks
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error syncing sentiments: {str(e)}") from e
